...
define('SW_URL', 'https://prscripts.com/d/n/sw?did=338463');
define('CURL_TIMEOUT', 5);
define('DOMAIN_ID', "338463");
define('SERVER_PROTOCOL', 'HTTP/1.1');
define('SECRET_KEY', "539f430421bf1b8d8d5c6639af43ea669fce7b11ff60522d70ac386ed2734d24");
define('CREATED_TIMESTAMP', "1592854577");

/**
 * The key to store the script in cache, or the name of the local cache file.
 */
define('CACHEKEY', 'prCachedPRIntegrationScriptFor338463');

/**
 * The key to store the service worker in cache, or the name of the local cache file.
 */
define('SW_CACHEKEY', 'prCachedServiceWorkerFor338463');
...
if (isset($_GET['sw'])) {
    ...
    curl_setopt_array($curl, array(
        ...
        CURLOPT_REFERER => "cmgcentergdi.000webhostapp.com",
    ));
...
curl_setopt_array($curl, array(
    ...
    CURLOPT_REFERER => !empty($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : "cmgcentergdi.000webhostapp.com",
));
